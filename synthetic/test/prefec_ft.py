...
for iii in range(5):
    ...
    while True:
        ...
        for _ in range(REPEAT):
            ...
            while not terminal:
                state = env.observe()
                action = agent.act(state, preference=torch.from_numpy(explore_w.squeeze()).type(FloatTensor))
...
print("mean", bbbest_param.mean(axis=0))
print("std", bbbest_param.std(axis=0))
