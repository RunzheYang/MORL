...
class LunarLander(gym.Env):
    ...
    def _render(self, mode='human', close=False):
        ...
        for x in [self.helipad_x1, self.helipad_x2]:
            ...
            self.viewer.draw_polygon( [(x, flagy2), (x, flagy2-10/SCALE), (x+25/SCALE, flagy2-5/SCALE)], color=(1.0,1.0,0.0))

        for x in [self.helipad_x1_2, self.helipad_x2_2]:
            flagy1 = self.helipad_y_2
            flagy2 = flagy1 + 50/SCALE
            self.viewer.draw_polyline( [(x, flagy1), (x, flagy2)], color=(1,1,1) )
            self.viewer.draw_polygon( [(x, flagy2), (x, flagy2-10/SCALE), (x+25/SCALE, flagy2-5/SCALE)], color=(0.0,0.5,1.0) )

        for x in [self.helipad_x1_3, self.helipad_x2_3]:
            flagy1 = self.helipad_y_3
            flagy2 = flagy1 + 50/SCALE
            self.viewer.draw_polyline( [(x, flagy1), (x, flagy2)], color=(1,1,1) )
            self.viewer.draw_polygon( [(x, flagy2), (x, flagy2-10/SCALE), (x+25/SCALE, flagy2-5/SCALE)], color=(1.0,0.0,0.2) )
...
def heuristic(env, s, target=0):
    ...
    angle_targ = (s[0]+x_offset)*0.5 + s[2]*1.0     # angle should point towards center (s[0] is horizontal coordinate, s[2] hor speed)
